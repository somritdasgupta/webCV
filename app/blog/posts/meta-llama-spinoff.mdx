---
title: "Why Zuckerberg Seems More Invested On LLaMA Than His Metaverse?"
publishedAt: "2024-01-07"
summary: "Mark Zuckerberg's all about LLaMA now, what's up with that? What happened to his metaverse ambition?"
---

![llama](https://media.licdn.com/dms/image/D5612AQGli3TBX2AbaA/article-cover_image-shrink_720_1280/0/1677536191104?e=1727913600&v=beta&t=ApO8zKFUoQWmsuaC52knky5YzMcCQhRcm7ydZeSpBLc)

## Table of Contents

- [Where It All Started](#where-it-all-started)
- [Why Open-Source Is a Game-Changer with a caveat](#why-open-source-is-a-game-changer-with-a-caveat)
- [The Metaverse: A Dream Deferred?](#the-metaverse-a-dream-deferred)
- [Two Big Plays: AI and the Metaverse](#two-big-plays-ai-and-the-metaverse)
- [The Synergy Potential](#the-synergy-potential)
- [The Risks and Trade-Offs](#the-risks-and-trade-offs)
- [The Bigger Gamble: Betting on Two Horses](#the-bigger-gamble-betting-on-two-horses)

### Where it all started

Let’s talk LLaMA; it's Meta’s signature AI model. With LLaMA 3.1 striking around the corner, Meta’s making waves in the already hyped up AI Bubble. Why’s this such a big deal? For starters, it’s open-source, which means it’s like a giant tech playground where anyone can come and play. Most of the competitors, like Anthropic's Claude, OpenAI's GPT, and Google's Gemini, have their ecosystems licensed under commercial agreements, which means large-scale experimentation with these models can be quite expensive.
...
While OpenAI's flagship GPT-4 model costs a hefty $60 to generate a million tokens, the cost of running Llama models on various hardware configurations shows a different picture.
...
So, what’s Zuckerberg’s grand gamble? It looks like he’s betting on both LLaMA and the metaverse, each with its own timeline and potential. Though Zuckerberg has the cash to pursue both of these dreams, but the problem is both of theese dreams are also cost billions and billions of dollars.
