  ...
  return (
    <section className="flex flex-col items-start text-gray-900 dark:text-gray-100">
      <div className="text-left">
        <h1 className="text-6xl font-bold !text-[var(--bronzer)] mb-8 mt-6 ">Purrr!!</h1>
        ...
        <Link href="/">
          <button className="mt-8 mb-8 py-2 px-8 rounded-lg transition duration-300 block px-2 py-2 text-sm font-medium bg-[var(--bronzer)]/25 rounded-lg flex items-center justify-center max-w-[120px] w-full sm:w-auto tracking-tight">
            HOME
          </button>
        </Link>
